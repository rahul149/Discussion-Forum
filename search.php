...
<body>
    ...
    <!-- Search Results -->
    <div class="search container my-3" style="min-height:80vh" ;">
         ...
         while($row = mysqli_fetch_assoc($result)){
            $no_result=false;
             echo '<div class="result">
                <h3><a href="thread.php?threadid='.$row["thread_id"].'" class="text-dark">'.$row["thread_title"].'</a></h3>
                 <p>'.$row["thread_desc"].'</p>
                </div>';
         }
         if($no_result)
