...
<body>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <!-- <img src="https://source.unsplash.com/1800x500/?apple" class="d-block w-100" alt="..."> -->
    ...
    <div class="container my-3">
        <h2 class="text-center">Welcome to Let's Discuss Forum - Categories </h2>

        <!-- Fetch All Categories using loop -->
        <div class="row">
            <?php  
            ...
            while($row = mysqli_fetch_assoc($result)){
                ...
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body">
                    <h5 class="card-title "><a href="threads.php?catid='.$id.' "  class="text-dark"> '.$cat.'</a></h5>
                    <p class="card-text">'.substr($row["cat_description"],0,50).'...</p>
